...
const DEFAULT_PROFILE: StudentProfile = {
  ...
  university: 'Universidad Nacional de Caaguazú',
  faculty: 'Facultad de Ciencias Médicas (FCM)',
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
            <div className="relative group cursor-pointer" onClick={() => setIsEditing(true)}>
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden p-1 bg-gradient-to-tr from-[var(--theme-accent)] via-white/50 to-[var(--theme-secondary)] shadow-lg shadow-black/10">
                <img
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-sm font-semibold text-[var(--theme-accent)]">{profile.title}</p>
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-1 text-xs text-[var(--theme-text-secondary)]">
                ...
                <span className="font-semibold text-[var(--theme-secondary)]">
                  {profile.career} ({profile.currentYear})
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-xs font-black text-[var(--theme-text-primary)]">{profile.gpa} / 5.0</span>
                </div>
              </button>
              ...
              <div className="px-3.5 py-1.5 rounded-2xl bg-[var(--theme-secondary-light)] border border-[var(--theme-secondary)] flex items-center gap-1.5 shadow-xs">
                ...
                <div className="text-left">
                  ...
                  <span className="text-xs font-black text-[var(--theme-nav-active-text)]">
                    {Math.round((profile.attendedClasses / (profile.totalClasses || 1)) * 100)}%
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6 pt-5 border-t border-[var(--theme-card-border)] text-xs text-[var(--theme-text-secondary)]">
          ...
          >
            ...
            <div className="overflow-hidden">
              ...
              <span className="font-semibold truncate max-w-[200px] block text-[var(--theme-text-primary)]">{profile.email}</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="overflow-hidden">
              ...
              <span className="font-semibold truncate block text-[var(--theme-text-primary)]">{profile.semester}</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="overflow-hidden">
              ...
              <span className="font-semibold truncate max-w-[200px] block text-[var(--theme-text-primary)]">{profile.university}</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl bg-white/90 border border-white outline-none focus:ring-2 focus:ring-[#864e5a]"
                  placeholder="Ej: Facultad de Ciencias Médicas"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl bg-white/90 border border-white outline-none focus:ring-2 focus:ring-[#864e5a]"
                  placeholder="Ej: Universidad Nacional de Caaguazú (UNCA)"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  max="5"
                  value={editForm.gpa}
                  onChange={(e) => setEditForm({ ...editForm, gpa: parseFloat(e.target.value) || 4.5 })}
              ...
              <div>
                <label className="font-bold text-[#514345] mb-1 block">Título / Especialidad</label>
                <input
                  type="text"
                  value={editForm.title}
                  onChange={(e) => setEditForm({ ...editForm, title: e.target.value })}
                  className="w-full p-2.5 rounded-xl bg-white/90 border border-white outline-none focus:ring-2 focus:ring-[#864e5a]"
                  placeholder="Ej: Estudiante Universitaria • 5to Año"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl bg-white/90 border border-white outline-none focus:ring-2 focus:ring-[#864e5a]"
                  placeholder="Ej: lbenitez54@fcmunca.edu.py"
                />
              </div>
            </div>
